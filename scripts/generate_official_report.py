# ==============================================================
# EFQM Official Report Generator
# (Persian + English, Unicode Safe, Auto Paths)
...
# --------------------------------------------------------------
# یافتن اولین شرکت از پوشه data/companies
# --------------------------------------------------------------
...
print(f"🔍 Searching for signature: {signature_file}")
...
c.drawString(2 * cm, 2.4 * cm, "ارزیاب ارشد مدل
